...
<div class="page-hero">
    <div>
        ...
        <p>Track all remittance shortages, monitor remaining balances, and record payments when riders settle them.</p>
    </div>
</div>
...
<div class="row g-3">
    <div class="col-lg-8">
        <div class="card h-100">
            <div class="card-header fw-semibold">Outstanding and Settled Shortages</div>
                    ...
                    <tbody>
                        <?php foreach ($shortages as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?= $item['shortage_status'] === 'OPEN' ? 'text-bg-danger' : 'text-bg-success' ?>">
                                        <?= esc($item['shortage_status']) ?>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" class="bg-light">
                                    <?php if ($item['outstanding_balance'] > 0): ?>
                                    ...
                                    <?php else: ?>
                                        <div class="text-success small fw-semibold">This shortage is fully settled.</div>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        <?php if (empty($shortages)): ?>
                            <tr><td colspan="6" class="text-center text-muted py-4">No shortage records found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
