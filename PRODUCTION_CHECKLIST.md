...
8. Create or rotate the initial admin password before first login.
...
12. Run `php vendor/bin/phpunit` before deploy and add feature tests for login, rider submission approval, remittance save, and payroll generation before the next release.
